import { ProductWithUI, CartItem, Coupon, Discount } from "../../../types";
import { getRemainingStock, calculateItemTotal } from "../../models/carts";
                    ...
                    <div className="relative">
                      ...
                      {product.discounts.length > 0 && (
                        <span className="absolute top-2 left-2 bg-orange-500 text-white text-xs px-2 py-1 rounded">
                          ~{Math.max(...product.discounts.map((d: Discount) => d.rate)) * 100}%
                        </span>
                      )}
                    </div>
